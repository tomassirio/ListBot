...
module.exports = {
    ...
    execute(message, args) {
        ...
        msg +=
            '**' +
            process.env.PREFIX +
            'multi-add {element} {element}** - to add multiple elements to the list\n'
        msg +=
            '**' +
            process.env.PREFIX +
        ...
        msg +=
            '**' +
            process.env.PREFIX +
            'multi-remove {element} {element}** - to remove multiple elements from the list\n'
        msg +=
            '**' +
            process.env.PREFIX +
        ...
        msg +=
            '**' +
            process.env.PREFIX +
            'poll {active_time_in_minutes}** - creates a poll on the channel for 5 random elements. WIP\n'
        msg +=
            '**' +
            process.env.PREFIX +
        ...
        msg +=
            '**' +
            process.env.PREFIX +
            'remind {time_in_minutes} {element}** - to add an item and be reminded in n minutes\n'
